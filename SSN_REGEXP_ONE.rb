=begin
Add additional driver code where you want to feel more comfortable with your implementation. 
For instance, what happens when you pass a string with only a single SSN into the hide_all_ssns or get_all_ssns methods?
...
puts grab_all_ssns("345-45-1234 is the new literacy") == ["345-45-1234"]
...
puts hide_all_ssns("234-60-1422 this is the jammer") == "XXX-XX-1422 this is the jammer"
